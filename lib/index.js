...
var classMembers = {
  ...
  use: function( features ) {
    ...
    this._features = this._features.concat( preProcessFeatures( features ) );
    return this;
  },
  ...
  getComposed: function() {
    ...
    if ( Array.isArray( features ) && features.length > 1 ) {
      return compose.call( this, features );
    } else {
      return this;
    }
  }
...
function compose( features ) {
  ...
  addToWrapped( preFns.instanceMethods, instanceMethodWrapped, 'pre', instanceExtender, parent.prototype, this.prototype );
  addToWrapped( postFns.instanceMethods, instanceMethodWrapped, 'post', instanceExtender, parent.prototype, this.prototype );
  addToWrapped( preFns.classMethods, classMethodWrapped, 'pre', classExtender, parent, this );
  addToWrapped( postFns.classMethods, classMethodWrapped, 'post', classExtender, parent, this );
  ...
  function addToWrapped( source, target, name, extender, parent, scope ) {
    Object
      .keys( source )
